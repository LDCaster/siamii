        ...
        <form action="<?= base_url('/siklus/update/' . $siklus['id']); ?>" method="post" class="row g-3">
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control <?= (session('errors.tahun')) ? 'is-invalid' : ''; ?>" id="tahun" name="tahun" value="<?= old('tahun', $siklus['tahun']); ?>" min="2023-01-01" max="2025-12-31" step="1">
                    <label for="tahun">Tahun Akademik <span style="color: red;">*</span></label>
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    ...
                    <label for="periode">Periode Akademik <span style="color: red;">*</span></label>
