...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Pelaksanaan Evaluasi Audit</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($proses['status'] == 1 || $isAdmin) : ?>
                                            <a href="<?= base_url('hasil-ami/detail-audit/' . $proses['id']); ?>" class="btn btn-primary btn-sm"><i class="bi bi-eye-fill" title="Detail"></i></a>
                                        <?php else : ?>
