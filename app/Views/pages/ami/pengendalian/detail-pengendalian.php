                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($hasil['bukti_rtm'] && $hasil['bukti_rtl']) : ?>
                                            <a href="<?= base_url('hasil-ami/pengendalian/' . $hasil['id']); ?>" class="btn btn-success btn-sm">
                                                <i class="bi bi-arrow-up-circle-fill" title="Pengendalian"></i>
                                            </a>
                                        <?php else : ?>
                                            <a href="<?= base_url('hasil-ami/pengendalian/' . $hasil['id']); ?>" class="btn btn-warning btn-sm">
                                                <i class="bi bi-arrow-up-circle-fill" title="Pengendalian"></i>
                                            </a>
                                        <?php endif; ?>
